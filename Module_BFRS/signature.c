...
void KeyGen(poly_matrix A, poly_matrix T, cplx_poly_matrix cplx_T, cplx_poly_matrix sch_comp)
	...
	// A_hat_coeffs est bien de taille d*d dans l'algo TrapGen + chacun de ses éléménents est un polynôme à n variables
	// AprimeT_coeffs désigne A'*T qui est bien de taille d*dk dans l'algo TrapGen.
	// Le début de cet algorithme KeyGen ressemble à celui de l'algo TrapGen. Pourquoi n'ont ils pas repris la fonction qu'ils avaient écrit ?
